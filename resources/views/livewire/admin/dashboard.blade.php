                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h1 class="mt-1 mb-3">{{count($countAllProduct)}}</h1>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h1 class="mt-1 mb-3">{{count($countAllPackages)}}</h1>
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h1 class="mt-1 mb-3">{{count($countAllUsers)}}</h1>
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h1 class="mt-1 mb-3">{{count($countAllOrders)}}</h1>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 d-flex">
                            <div class="card flex-fill">
                                ...
                                <table class="table table-borderless my-0">
                                    ...
                                    <tbody>
                                    @foreach($countAllProduct as $key=>$product)
                                        <tr>
                                            <td>{{$key+1}}.</td>
                                            <td>
                                                <div class="d-flex">
